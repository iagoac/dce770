...
O trabalho prático será realizado em um total de 4 etapas interdependentes.
 ...
 2. [Definição de instâncias de teste e implementação de um algoritmo da literatura para o problema](etapa2/README.md)
 3. [Implementação de uma heurística/metaheurística própria para o problema](etapa3/README.md)
